 ...
 */
export const createConsultation = async (consultationInput: ConsultationInput, options?: Parameters<typeof customFetch>[1]): Promise<ConsultationRequest> => {
...
return customFetch<ConsultationRequest>(getCreateConsultationUrl(),
  {
    ...options,
    method: 'POST',
...
export const getCreateConsultationMutationOptions = <TError = ErrorType<Error>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateConsultationMutationError = ErrorType<Error>
    export type CreateConsultationMutationVariables = {data: BodyType<ConsultationInput>}

    /**
 * @summary Submit a consultation request
 */
export const useCreateConsultation = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createConsultation>>, TError,CreateConsultationMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
